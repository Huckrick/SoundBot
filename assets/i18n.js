...
const i18n = {
    ...
    translations: {
        zh: {
            ...
            'settings.ai.tab.llm': 'LLM 模型',
            'settings.ai.tab.embedding': 'Embedding 模型',
            'settings.ai.select.provider': '选择 LLM 提供者',
            'settings.ai.category.local': '本地模型',
            'settings.ai.category.cloud': '云服务',
            'settings.ai.category.custom': '自定义',
            'settings.ai.provider.custom.api': '自定义 API',
            'settings.ai.provider.custom.desc': '使用其他 OpenAI 兼容格式的 API',
            'settings.ai.config.custom.title': '自定义 API 配置',
        ...
        en: {
            ...
            'settings.ai.tab.llm': 'LLM Model',
            'settings.ai.tab.embedding': 'Embedding Model',
            'settings.ai.select.provider': 'Select LLM Provider',
            'settings.ai.category.local': 'Local Models',
            'settings.ai.category.cloud': 'Cloud Services',
            'settings.ai.category.custom': 'Custom',
            'settings.ai.provider.custom.api': 'Custom API',
            'settings.ai.provider.custom.desc': 'Use other OpenAI-compatible APIs',
            'settings.ai.config.custom.title': 'Custom API Configuration',
